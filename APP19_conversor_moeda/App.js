  ...
  render() {
    return(
      <View style={styles.container}>
        ...
        source={{uri:'https://static.vecteezy.com/ti/vetor-gratis/t2/1829850-banco-juros-e-investimento-olhar-para-fundo-mutuo-e-opcao-moeda-para-obter-maximo-lucro-para-retorno-sobre-investimento-roi-personagem-conceito-ilustracao-para-web-landing-page-mobile-apps-card-gratis-vetor.jpg'}}
        />
            ...
            <TextInput style={styles.input}
              ...
              placeholder=" Insira o valor para conversão "/>
